...
export const fileUtilModifyHTML = (assetsDir, templateName) => {
    let closingBodyIndex, modifiedData, sanitize, templatePath;
    ...
    fs.readFile(templatePath, "utf8", function (err, data) {
        ...
        modifiedData =
            sanitize.slice(0, closingBodyIndex) +
            library +
            sanitize.slice(closingBodyIndex);
